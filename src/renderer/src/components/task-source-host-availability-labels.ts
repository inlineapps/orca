...
export type UnavailableHost = { hostLabel: string; statusLabel: string }
...
export function getUnavailableHosts(
  ...
  const unavailableHosts: UnavailableHost[] = []
...
export function getAvailabilityLabel(unavailableHosts: readonly UnavailableHost[]): string | null {
